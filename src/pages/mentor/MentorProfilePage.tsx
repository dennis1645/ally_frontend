...
import { mentorSidebarItems } from "./MentorShared";
...
function getRoleName(
  ...
  if (role && typeof role === "object") {
    ...
    return formatText(
      roleObject.name ?? roleObject.slug,
    );
  }
                          ...
                          <div>
                            ...
                            <p className="text-sm leading-relaxed text-slate-600">
                              {currentUser.headline?.trim() ||
                                "No mentor headline has been added yet."}
                            </p>
                          </div>
                  ...
                  <div className="mt-7">
                    ...
                    <div className="mt-7 grid gap-4 sm:grid-cols-2">
                      ...
                      <InformationItem
                        ...
                        label="Availability"
                        value="Open for live mentoring sessions"
                      />
                    ...
                    <div className="mt-7 rotate-[-1deg] rounded-2xl border-2 border-dashed border-[#c69c6e] bg-[#fff8e8] p-5">
                      ...
                      <p className="mt-2 leading-relaxed text-slate-600">
                        {currentUser.bio?.trim() ||
                          "Your mentoring philosophy and guidance notes will grow here as you support more explorers."}
                      </p>
