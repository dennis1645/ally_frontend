...
export default function ChooseAdventurePage() {
  ...
  const texts = {
    ...
    opt1Desc:
      "Create your Ally account to unlock your personalized scholarship roadmap, AI guidance, milestone tracking, coaching, and progress management.",
    opt1Btn: "Start My Expedition",

    opt2Title: "I’m still considering…",
    opt2Desc:
      "Take a quick scholarship readiness assessment to discover how prepared you are before creating an account. It’s free and takes only five minutes!",
  ...
  const [currentStep, setCurrentStep] = useState<"intro" | "options">(
    "intro"
  );
  ...
  useEffect(() => {
    ...
    const runTypewriter = async () => {
      // 1. Type main text
      for (let i = 1; i <= texts.mainText.length; i++) {
        if (isCancelled) return;

        setDisplayedText(texts.mainText.slice(0, i));
      ...
      // Small pause before the second line
      await new Promise((resolve) => setTimeout(resolve, 350));

      // 2. Type Ally + remaining text
      const totalSubChars =
        1 + texts.llyText.length + texts.restText.length;
  ...
  return (
    <>
      <style>
        {`
          ...
          .hover-glow:hover {
            ...
            box-shadow:
              0 0 35px 10px rgba(188, 222, 255, 0.7),
          ...
          .page-exit {
            animation:
              mapZoomExit 0.9s cubic-bezier(0.25, 1, 0.5, 1)
              forwards;
          }
        `}
      </style>
      ...
      <div
        className={[
          "choose-adventure-page relative flex h-dvh min-h-0 overflow-hidden",
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none fixed inset-0 z-0 bg-white/20"
        />
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(255,255,255,0.55) 2px, transparent 2px), linear-gradient(90deg, rgba(255,255,255,0.55) 2px, transparent 2px)",
        ...
        <main
          className={[
            "choose-adventure-shell relative z-10 mx-auto flex h-full w-full",
            "max-w-5xl flex-col items-center justify-center px-4 py-4",
            "sm:px-6 lg:px-8",
          ...
          {currentStep === "intro" ? (
            <div className="flex w-full flex-col items-center justify-center gap-4 sm:gap-6 md:gap-7">
              ...
              <header className="flex shrink-0 flex-col items-center text-center">
                ...
                <h1 className="text-mengkilap mt-3 pb-2 text-center text-3xl font-extrabold leading-normal tracking-[-0.04em] drop-shadow-sm sm:mt-4 sm:pb-3 sm:text-4xl md:text-5xl lg:text-6xl">
                  {texts.title}
                </h1>
              </header>
              ...
              <section
                ...
                className="relative w-[95%] max-w-2xl shrink-0"
              >
                <div className="relative rounded-[24px] border-[3px] border-[#6c513e] bg-[#fae8dd] px-5 py-4 text-center shadow-[0_6px_14px_rgba(61,37,20,0.14)] sm:px-8 sm:py-6 md:px-10 md:py-8">
                  ...
                  <p className="mt-3 min-h-[1.5rem] text-sm font-bold text-[#3d2514] sm:mt-4 sm:min-h-[2rem] sm:text-base md:text-xl">
                    ...
                    {subCharCount > 4 && (
                      <span>
                        {texts.restText.slice(
                          0,
                          Math.max(0, subCharCount - 4)
                        )}
                      </span>
                    )}
                  </p>
              ...
              <div className="flex flex-col items-center">
                <div className="flex h-[130px] w-[130px] shrink-0 items-center justify-center sm:h-[170px] sm:w-[170px] md:h-[200px] md:w-[200px]">
                  <img
                    src={allyMascot}
                    alt="Ally mascot"
                    className="animate-mascot h-full w-full object-contain drop-shadow-xl"
                  />
                </div>
                ...
                <button
                  ...
                  className="-mt-4 inline-flex min-h-[44px] shrink-0 items-center justify-center gap-2 rounded-2xl border-b-4 border-[#3270c5] bg-[#6ba8e6] px-6 text-sm font-extrabold text-[#183954] shadow-sm transition hover:bg-[#5d9fe0] active:translate-y-[2px] active:border-b-2 sm:-mt-6 sm:min-h-[48px] sm:gap-3 sm:px-7 sm:text-base md:-mt-8"
                >
                  {texts.btnChoose}
            ...
            <div className="flex h-full w-full flex-col items-center justify-center">
              ...
              <button
                ...
                className="mb-4 inline-flex shrink-0 items-center gap-2 rounded-xl px-4 py-2 text-sm font-bold text-[#5a4332] transition hover:bg-white/60 sm:mb-6"
              >
                <ArrowLeft
                  size={18}
                  aria-hidden="true"
              ...
              <section
                ...
                className="relative z-20 grid w-full max-w-4xl grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2"
              >
                {/* Option 1 */}
                  ...
                  <AdventureOptionCard
                    ...
                    description={
                      <p className="text-sm leading-relaxed text-[#5a4332] sm:text-base md:text-[17px]">
                        ...
                        account to unlock your personalized scholarship
                        roadmap, AI guidance, milestone tracking, coaching,
                        and progress management.
                      </p>
                    }
                    buttonLabel={texts.opt1Btn}
                    buttonIcon={
                      <ArrowRight
                        size={18}
                        aria-hidden="true"
                ...
                <div className="hover-glow h-full cursor-pointer rounded-[24px] [&>*]:h-full">
                  <AdventureOptionCard
                    ...
                    title={texts.opt2Title}
                    description={
                      <p className="text-sm leading-relaxed text-[#5a4332] sm:text-base md:text-[17px]">
                        {texts.opt2Desc}
                      </p>
                    }
                    buttonLabel={texts.opt2Btn}
                    buttonIcon={
                      <BarChart3
                        size={18}
                        aria-hidden="true"
