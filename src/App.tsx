...
// FIX 1: Import default tanpa kurung kurawal
...
import { MentorDocumentsPage } from "./pages/mentor/MentorDocumentPage"; 
import { MentorSettingsPage, MentorSupportPage } from "./pages/mentor/MentorSettingSupport";
// FIX 2: Import ActionItems, Bookings, dan Sessions DIHAPUS karena file-nya sudah digabung
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/choose-adventure" element={<ChooseAdventurePage />} />

        <Route
          path={INITIAL_ASSESSMENT_ROUTE}
          element={<InitialAssessmentRouteElement />}
        />
        ...
        <Route element={<EmailVerificationCallbackGate />}>
          ...
          <Route element={<RoleRoute allowedRoles={["user"]} />}>
            ...
            <Route path="/verification-pending" element={<Navigate to="/verify-email" replace />} />

            <Route path="/dashboard" element={<DashboardPage />} />
            <Route path="/profile" element={<ProfilePage />} />
            <Route path="/profile/journey-log" element={<ProfilePage />} />
            <Route path="/profile/security" element={<ProfilePage />} />
            <Route path="/profile/edit" element={<EditProfilePage />} />
            <Route path="/assessment-2" element={<Assessment2Page />} />

            <Route path="/onboarding" element={<Navigate to="/onboarding/profile" replace />} />
            <Route
              path="/onboarding/profile"
              element={<EmptyPage title="Profile Onboarding" description="Profile and scholarship preference onboarding will be implemented here." />}
            />
            <Route
              path="/onboarding/readiness"
              element={<EmptyPage title="Readiness Result" description="The user's initial readiness result will be displayed here." />}
            />
            <Route
              path="/onboarding/primary-target"
              element={<EmptyPage title="Select Primary Target" description="The user will select their primary scholarship target here." />}
            />

            <Route path="/quests" element={<QuestTrackerPage />} />
            <Route path={ASSESSMENT_2_ROUTE} element={<Assessment2Page />} />
            <Route path="/quests/document-valley" element={<DocumentValleyPage />} />
            <Route path="/quests/essay-pass" element={<EssayPassPage />} />

            <Route
              path="/scholarships"
              element={<EmptyPage title="Scholarship Catalogue" description="Available scholarship opportunities will be displayed here." />}
            />
            <Route
              path="/documents"
              element={<EmptyPage title="Document Vault" description="Uploaded scholarship documents will be managed here." />}
            />

            <Route path="/ally" element={<AIMentorPage />} />
            <Route path="/sessions" element={<CoachingPage />} />
          ...
          <Route element={<RoleRoute allowedRoles={["mentor"]} />}>
            ...
            <Route
              ...
              element={<EmptyPage title="Mentee Profile" description="The selected mentee's preparation profile will be displayed here." />}
            />
            
            <Route path="/mentor/dossier" element={<MentorDossierPage />} />
            <Route path="/mentor/availability" element={<MentorAvailabilityPage />} />
            <Route path="/mentor/action-plans" element={<MentorActionPlansPage />} />
            ...
            {/* FIX 3: Route untuk Bookings, Sessions, dan Action Items DIHAPUS */}
          </Route>
          ...
          <Route element={<RoleRoute allowedRoles={["admin"]} />}>
            ...
            <Route
              ...
              element={<EmptyPage title="Edit Scholarship" description="Update an existing scholarship entry." />}
            />

            <Route path="/admin/assessment" element={<InitialAssessmentAdmin />} />
            <Route path="/admin/shop" element={<ItemShopAdmin />} />
            ...
            <Route
              ...
              element={<EmptyPage title="User Detail" description="View and manage an individual platform user." />}
            />
            <Route
              path="/admin/payments"
              element={<EmptyPage title="Payment Management" description="Monitor payments, transaction status, and package activation." />}
            />
            <Route
              path="/admin/mentors"
              element={<EmptyPage title="Mentor Management" description="Manage mentor accounts, profiles, and availability." />}
            />
            <Route
              path="/admin/capacity"
              element={<EmptyPage title="Capacity Monitoring" description="Monitor mentor availability and platform capacity." />}
            />
            <Route
              path="/admin/analytics"
              element={<EmptyPage title="Platform Analytics" description="Review user activity, sales, and feature usage." />}
            />
            <Route
              path="/admin/settings"
        ...
        <Route
          path="*"
          element={<EmptyPage title="Page Not Found" description="The requested expedition route does not exist." />}
        />
      </Routes>
    </>
  );
