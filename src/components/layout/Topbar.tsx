...
import { Backpack, Bell, LogOut, Menu, UserRound } from "lucide-react";
...
export default function Topbar({
  ...
  const showExplorerTools = !isMentorArea && !isAdminArea;

  const profilePath = isMentorArea ? "/mentor/profile" : "/profile";
  ...
  const displayLevel = user?.level ?? user?.expedition_level ?? null;
